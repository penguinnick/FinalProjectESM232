...
Agricultural yields have great variation in the same crop by year, location, and farming strategies This makes greating a general yield function for a specific crop challenging. To address this, we have followed a similar approach to Gulland et al. 1996 by making our agricultural modeling component adaptable. This model uses an input dataframe with at least 30 years of yield data. This can either be specific data for the farm studied or averages in the area of interest. Like Gulland et al. 1996, our function uses a normal distribution to account for the variation 
