...
##sdp_res = mapply(FUN=sdp_farm,  hsr=sens_sdp_sobel$X$hsr, max_store=sens_sdp_sobel$X$max_store, PrS=sens_sdp_sobel$X$PrS, PrGood=sens_sdp_sobel$X$PrGood, D.good=sens_sdp_sobel$X$D.good, D.bad=sens_sdp_sobel$X$D.bad, mean.ylds=c(sens_sdp_sobel$X$wl, sens_sdp_sobel$X$bl), MoreArgs=list(parms=parms, crop.parms=crop.parms, stock.parms=stock.parms))
